    ...
    curses: [
        {
            course : "HTML",
            red : "Polygon",
            img : "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQpngGRjYX1ca7qAADU3K6eGLj7ShQE3L2otdzfryl_Y9Ht2QRoQKYQbsXd36XIxMbYOw0&usqp=CAU",           percentage : "20%"
          }
        ],
    certificates: [
        {
     ...
     <div className={style.certificates}>
        <div className={style.barra}>
            ...
            <div className={style.btn}>
                <button onClick={() => setCurses(!curses)}>Certificados</button>
